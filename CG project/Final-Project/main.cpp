...
glBegin(GL_QUADS);           //building3
 ...
 glVertex2f(-0.97,0.3);////building1
 glVertex2f(-0.92,0.3);

 glVertex2f(-0.97,0.4);////building1
 glVertex2f(-0.92,0.4);

   glVertex2f(-0.97,0.5);////building1
 glVertex2f(-0.92,0.5);
 ...
 glVertex2f(-0.62,0.22);
   glVertex2f(-0.67,0.45);////building3
